...
import com.fastporte.ServiceService.service.IContractService;
import com.fastporte.ServiceService.service.INotificationService;
...
public class ContractController {
    ...
    public ContractController(IContractService contractService, IStatusContractService statusContractService, INotificationService notificationService) {
    ...
    public ResponseEntity<Contract> insertContract(@PathVariable("clientId") Long clientId,
        ...
        try {
            ...
            contract.setNotification(notificationService.getById(1L).get());
